  ...
  return knex("gmr_events")
    ...
    .then(() =>
      ...
      knex("gmr_events").insert([
        ...
        {
          id: 3,
          datetime: "2020-01-15T01:15:00.000Z",
          details:
        ...
        {
          id: 2,
          datetime: "2020-01-08T01:15:00.000Z",
          details:
        ...
        {
          id: 1,
          datetime: "2020-01-01T01:15:00.000Z",
          details:
        ...
        {
          id: 5,
          datetime: "2020-01-29T01:15:00.000Z",
          details:
        ...
        {
          id: 6,
          datetime: "2020-02-12T01:15:00.000Z",
          details:
        ...
        {
          id: 7,
          datetime: "2020-02-05T01:15:00.000Z",
          details:
        ...
        {
          id: 8,
          datetime: "2020-02-19T01:15:00.000Z",
          details:
    ...
    .then(() => knex.raw("ALTER SEQUENCE gmr_events_id_seq RESTART WITH 11;"))
}
