  ...
  <div class="slack-invite" v-bind:class="[status ? 'invite-success' : '']">
    ...
    <transition name="notification-pop-fast">
      <div class="invite-notice" v-show="heads_up">
        <h3>Heads up!</h3>
        <p>When you request an invite it requires an administrator to review and approve it - we'll be available pretty often to handle that but this is not an automated system and may take time. Give us at least 24 hours.</p>
      </div>
    </transition>
